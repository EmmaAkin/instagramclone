...
def create_user_profile
  ...
  dummy.each do|user|
      ...
      dummy_user = User.create!(
        ...
        dateofbirth: Faker::Date.between(18.years.ago, 80.years.ago),
        image: ["https://d3iw72m71ie81c.cloudfront.net/female-4.jpg","https://d3iw72m71ie81c.cloudfront.net/female-90.jpg"].sample
        )
